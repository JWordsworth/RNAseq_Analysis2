...
dir_name = r"/media/njw262/DATA/RNAseq_Analysis/campisi_data"
...
#forwards_file = '/media/njw262/DATA/RNAseq_Analysis/campisi_data/Melanocytes/IR4/ERR1805192_1.fastq'
#bakward_file = '/media/njw262/DATA/RNAseq_Analysis/campisi_data/Melanocytes/IR4/ERR1805192_2.fastq'
...
files = glob.glob("/media/njw262/DATA/RNAseq_Analysis/campisi_data/Keratinocytes/IR20/*.fastq")
# print(files)
list1 = []
list2 = []
